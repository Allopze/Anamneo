...
export default function RevokeConsentModal({
  ...
  return (
    <Dialog
      ...
      description="La revocación detiene el tratamiento basado en este consentimiento."
    ...
    >
      ...
      <div className="flex items-center justify-end gap-3 rounded-b-card border-t border-surface-muted/30 bg-surface-base/40 px-6 py-4">
        <button ref={cancelRef} type="button" onClick={onCancel} disabled={isPending} className="btn btn-secondary">
          Cancelar
        </button>
