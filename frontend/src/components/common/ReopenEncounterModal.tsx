...
export default function ReopenEncounterModal({
  ...
  return (
    <Dialog
      ...
      description="Registra el motivo de reapertura antes de volver a edición"
      ...
      <div className="flex items-start justify-between gap-4 border-b border-surface-muted/35 px-6 py-5">
        <div className="min-w-0">
          <div className="flex items-center gap-2 text-ink">
            <FiEdit3 className="h-4 w-4 text-ink-secondary" aria-hidden="true" />
            <h2 className="text-lg font-semibold">Reabrir atención</h2>
          </div>
