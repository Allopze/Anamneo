...
export function useEncounterWizard() {
  ...
  return {
    ...
    activeWorkspacePanel: navigation.activeWorkspacePanel,
    setActiveWorkspacePanel: navigation.setActiveWorkspacePanel,
    isOnline,
    pendingSaveCount: persistence.pendingSaveCount,
    completedCount,
    progressPercentage,
    ...
    persistSection: persistence.persistSection,
    handleSectionDataChange: persistence.handleSectionDataChange,
    handleRestoreRecoverableConflict: persistence.handleRestoreRecoverableConflict,
    handleDismissRecoverableConflict: persistence.handleDismissRecoverableConflict,
    ...
    openWorkspacePanel: navigation.openWorkspacePanel,
