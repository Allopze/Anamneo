...
module.exports = {
  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        'soft':     '0 1px 2px rgba(var(--frame-dark-rgb), 0.035), 0 12px 28px -24px rgba(var(--frame-dark-rgb), 0.20)',
        'card':     '0 1px 2px rgba(var(--frame-dark-rgb), 0.045), 0 18px 42px -30px rgba(var(--frame-dark-rgb), 0.24)',
        'elevated': '0 1px 3px rgba(var(--frame-dark-rgb), 0.055), 0 28px 58px -34px rgba(var(--frame-dark-rgb), 0.28)',
        'dropdown': '0 1px 3px rgba(var(--frame-dark-rgb), 0.08), 0 22px 46px -28px rgba(var(--frame-dark-rgb), 0.32)',
      },
      fontSize: {
