...
export const AUDIT_REASON_LABELS: Record<AuditReason, string> = {
  ...
  PATIENT_REASSIGNED: 'Reasignación de paciente',
  ...
  ENCOUNTER_REASSIGNED: 'Reasignación de atención',
  ...
  ADMIN_MAINTENANCE_EXECUTED: 'Ejecución de mantenimiento administrativo',
  AUDIT_EMERGENCY_EVENT: 'Registro manual de evento de emergencia',
  ...
  MEDICATION_CREATED: 'Registro de medicamento activo',
  MEDICATION_UPDATED: 'Actualización de medicamento',
  MEDICATION_REMOVED: 'Eliminación (soft-delete) de medicamento',
