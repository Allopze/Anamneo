...
INSERT INTO "new_encounters" ("completed_at", "completed_by_id", "created_at", "created_by_id", "id", "medico_id", "patient_id", "review_requested_at", "review_status", "reviewed_at", "reviewed_by_id", "status", "updated_at") SELECT "completed_at", "completed_by_id", "created_at", "created_by_id", "id", "medico_id", "patient_id", "review_requested_at", "review_status", "reviewed_at", "reviewed_by_id", "status", "updated_at" FROM "encounters";
