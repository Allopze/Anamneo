...
INSERT INTO "new_attachments" ("category", "deleted_at", "deleted_by_id", "description", "encounter_id", "filename", "id", "linked_order_id", "linked_order_label", "linked_order_type", "mime", "original_name", "size", "storage_path", "uploaded_at", "uploaded_by_id") SELECT "category", "deleted_at", "deleted_by_id", "description", "encounter_id", "filename", "id", "linked_order_id", "linked_order_label", "linked_order_type", "mime", "original_name", "size", "storage_path", "uploaded_at", "uploaded_by_id" FROM "attachments";
